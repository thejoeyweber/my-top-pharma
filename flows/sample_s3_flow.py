"""
Sample Prefect Flow using S3 Block

This module demonstrates how to use the S3 block for storing flow artifacts.
"""
...
# Add the parent directory to sys.path to import utils and blocks
...
if __name__ == "__main__":
    # Get or create the S3 block
    s3_block = get_s3_block()
    print(f"Using S3 block with path: {s3_block.base_path}")
